...
Version: 10.0.1
Author: Merchan.Dev | Arturo Merchan
*/
    ...
    <script>
        (function (uid) {
            ...
            audio.addEventListener('error', function (e) {
                // Solo manejar error si estábamos intentando cargar o reproduciendo
                if (isLoading || isPlaying) {
            ...
            // Auto-reconexión si se corta el stream (stalled)
            ...
            // Recuperar si vuelve a reproducir tras buffering
            audio.addEventListener('playing', function () {
                clearTimeout(connTimeout);
                isPlaying = true;
                isLoading = false;
